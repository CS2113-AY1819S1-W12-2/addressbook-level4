...
Figure 1. Interactions inside the Logic component for the `restore 1` command.

image::restoreSequenceDiagramStorage.png[width="700"]
Figure 2. Interactions inside the Storage component for the `restore 1` command.
